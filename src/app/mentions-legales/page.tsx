        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-navy max-w-none space-y-8 text-navy-700">
            <section>
              ...
              <p>FinSoft est un logiciel édité par un développeur indépendant basé à Dijon, France.</p>
            ...
            <section>
              ...
              <p className="mt-2">Le logiciel FinSoft est installé <strong>localement sur le serveur du client</strong>. Aucune donnée comptable n&apos;est transmise à des tiers.</p>
            </section>

            <section>
              <h2 className="text-xl font-display font-semibold text-navy-900 mb-3">Propriété intellectuelle</h2>
              <p>L&apos;ensemble des éléments du logiciel FinSoft (code source, interface, documentation) est protégé par le droit d&apos;auteur. Toute reproduction ou diffusion sans autorisation écrite est interdite.</p>
            </section>

            <section>
              <h2 className="text-xl font-display font-semibold text-navy-900 mb-3">Responsabilité</h2>
              <p>FinSoft est un outil d&apos;aide à la comptabilité. Il ne se substitue pas au conseil d&apos;un expert-comptable agréé. L&apos;éditeur ne saurait être tenu responsable des décisions financières ou fiscales prises sur la base des données traitées par le logiciel.</p>
            </section>
